    ...
    <div class="container text-center mt-5">
        ...
        <div class="container mt-1 mb-1 d-flex justify-content-center">
            <div class="card" style="width: 50%;">
                ...
                <form method="post" action="<?php echo base_url('/post-usuario') ?>">
                    <div class="card-body" media="(max-width:768px)">
                        <div class="mb-3">
                            <label for="perfil" class="form-label"> Perfil</label>
                            <select name="perfil" class="form-control" id="perfil "
                                value="<?php echo set_value('perfil_id') ?>">
                                <option value="">Seleccionar perfil</option>
                                <?php foreach ($perfiles as $perfil) { ?>
                                <option value="<?php echo $perfil['id']; ?>"
                                    <?php if( old('perfil_id') === $perfil['id']): ?> selected="selected">
                                    <?php else : ?> >
                                    <?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="apellido" class="form-control"
                                value="<?php echo set_value('apellido')?>" placeholder="Apellido">
                            <!-- Error -->
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="direccion" class="form-control"
                                value="<?php echo set_value('direccion')?>" placeholder="Direccion">
                            <!-- Error -->
                        ...
                        <div class="mb-3">
                            ...
                            <input name="email" type="email" class="form-control"
                                value="<?php echo set_value('email')?>" placeholder="correo@algo.com">
                            <!-- Error -->
